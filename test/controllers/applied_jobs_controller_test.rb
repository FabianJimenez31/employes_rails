...
class AppliedJobsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applied_job" do
    assert_difference('AppliedJob.count') do
      post applied_jobs_url, params: { applied_job: { id_company: @applied_job.id_company, id_employee: @applied_job.id_employee, id_vacancy: @applied_job.id_vacancy } }
    end
  ...
  test "should update applied_job" do
    patch applied_job_url(@applied_job), params: { applied_job: { id_company: @applied_job.id_company, id_employee: @applied_job.id_employee, id_vacancy: @applied_job.id_vacancy } }
